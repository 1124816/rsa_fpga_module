...
#
# Generated by Vivado on Sun Mar 29 22:22:24 EDT 2020
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/media/Second/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"/media/Second/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_3 $vlogan_opts +v2k +incdir+"/media/Second/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/media/Second/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../bus_test.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/media/Second/workspace/Research/bus_test/bus_test.cache/compile_simlib/vcs"
  fi
